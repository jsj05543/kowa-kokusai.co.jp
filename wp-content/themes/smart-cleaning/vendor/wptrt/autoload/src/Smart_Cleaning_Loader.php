...
class Smart_Cleaning_Loader {
	 ...
	 * @return void
	 */
	public function smart_cleaning_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function smart_cleaning_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function smart_cleaning_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function smart_cleaning_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->smart_cleaning_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function smart_cleaning_load( $class ) {

...
class Smart_Cleaning_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function smart_cleaning_loadClassLoader($class)
    {
    ...
    public static function smart_cleaning_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
